<%@ Page Title="View Supplier" Language="C#" MasterPageFile="~/LoggedIn.Master" AutoEventWireup="true" CodeBehind="ViewSupplier.aspx.cs" Inherits="WebApplication.ViewSupplier" Async="true" %>
